...
export const regions: Region[] = [
  ...
  },
  {
    ...
    interact: "open a mission to see the brief",
    quests: [{ id: "R2:inspect", label: "open any mission brief" }],
    enterEvent: "entering region · FABRICATION YARDS",
    contentKind: "missions",
  },
  {
    code: "R3", region: "ARMORY VAULT", codename: "PARA-IX", classification: "DEPOT · LOW-SECURITY", title: "toolkit", jp: "武器庫",
  ...
  {
    code: "R4", region: "STARLIGHT COVE", codename: "AURI-2", classification: "STELLAR-NURSERY · LUSH", title: "interests", jp: "星海",
  ...
  {
    code: "R5", region: "OBSERVATORY DECK", codename: "MIRA-IV", classification: "GAS-GIANT · OBSERVABLE", title: "status", jp: "観測台",
  ...
  {
    code: "R6", region: "BEACON SUMMIT", codename: "OREN-PRIME", classification: "BEACON-RELAY · UPLINK", title: "open", jp: "灯台",
